/*
  ...
  1. Changes
    - Create comprehensive storage policies for model photos
    - Ensure proper access control for public and private content
    - Protect upload and delete operations

  2. Security
    - Public read access for non-private content
    - Admin-only access for private content
